          ...
          <button
            onClick={() => {
              setShowFinal(
                <img
                  width="200"
                  src="https://cdn.vox-cdn.com/thumbor/EaUuzIdnUGXAs_LokdLgtdrJZCY=/0x0:420x314/1400x1050/filters:focal(136x115:202x181):format(gif)/cdn.vox-cdn.com/uploads/chorus_image/image/55279403/tenor.0.gif"
                />
              );
          ...
          <button
            onClick={() => {
              setShowFinal(
                <img
                  width="200"
                  src="https://c.tenor.com/dp_hQBGT0rIAAAAd/think-smart.gif"
                />
              );
              setTimeout(() => setCount("5.5"), countTime);
              setChoice(false);
